...
songTitle.append("Still believe")
songTitle.append("Say Days Ago")
songTitle.append("Tonight's music")
songTitle.append("Lights out")
/*:
 - callout(Exercise):
 ...
 */
songTitle += ["Take it away", "Paralyzed", "Old wounds"]
...
for song in songTitle {
    print("The next song will be \(song). We need applaud")
}
