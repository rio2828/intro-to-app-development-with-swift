 ...
 */
var voteForBeach: Int = 0
var voteForChocolate: Int = 0

for i in tripDestinationVotes {
    if i == .beach {
        voteForBeach += 1
    } else if i == .chocolateFactory {
        voteForChocolate += 1
    } else {
        print(i)
    }
...
print("Beach got \(voteForBeach) votes and Chocolate Factory got \(voteForChocolate)")
 ...
 */
func countingVotes(_ votes: [SchoolMascotOption]) -> Void {
    var voteSalamander: Int = 0
    var voteMarmot: Int = 0
    var voteNeither: Int = 0
    ...
    print("Salamander got \(voteSalamander)votes, and Marmot got \(voteMarmot)Votes. \(voteNeither) people voted Neither")
}
countingVotes(mascotVotes)
